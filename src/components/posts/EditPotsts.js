    ...
    return (
        <Container>
            <Card>
                <CardBody id ="reset">
                    TITLE
                    <Input type="text" name="title" defaultValue={post?.data?.title} onChange={handleChange}/>
                    CONTENT
                    <TextAreaFloat type="text" name="content" defaultValue={post?.data?.content} onChange={handleChange}/>
                </CardBody>
                <CardFotter>
                    <Info>
